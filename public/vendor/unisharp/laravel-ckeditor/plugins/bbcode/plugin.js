...
(function() {
    CKEDITOR.on("dialogDefinition", function(a) {
        ...
        b = a.data.name;
        a = a.data.definition;
        "link" == b ? (a.removeContents("target"), a.removeContents("upload"), a.removeContents("advanced"), 
        b = a.getContents("info"), b.remove("emailSubject"), b.remove("emailBody")) : "image" == b && (a.removeContents("advanced"), 
        b = a.getContents("Link"), b.remove("cmbаTarget"), b = a.getContents("info"), b.remove("txtAlt"), 
        b.remove("basic"));
    });
    var l = {
        b: "strong",
        ...
        quote: "cite",
        list: "listType"
    }, n = CKEDITOR.dtd, A = CKEDITOR.tools.extend({
        table: 1
    }, n.$block, n.$listItem, n.$tableContent, n.$list), C = /\s*(?:;\s*|$)/, q = {
        smiley: ":)",
        sad: ":(",
        wink: ";)",
        laugh: ":D",
    ...
    CKEDITOR.BBCodeParser.prototype = {
        parse: function(a) {
            for (var b, c, h = 0; b = this._.bbcPartsRegex.exec(a); ) if (c = b.index, c > h && (h = a.substring(h, c), 
            this.onText(h, 1)), h = this._.bbcPartsRegex.lastIndex, (c = (b[1] || b[3] || "").toLowerCase()) && !l[c]) this.onText(b[0]); else if (b[1]) {
                var f = l[c], k = {}, g = {};
                if (b = b[2]) if ("list" == c && (isNaN(b) ? /^[a-z]+$/.test(b) ? b = "lower-alpha" : /^[A-Z]+$/.test(b) && (b = "upper-alpha") : b = "decimal"), 
                y[c]) {
                    "size" == c && (b += "%");
                    g[y[c]] = b;
                    b = k;
    ...
    CKEDITOR.htmlParser.fragment.fromBBCode = function(a) {
        function b(a) {
            if (0 < g.length) for (var f = 0; f < g.length; f++) {
                ...
                e && !e[c] || a && k && !k[a] && CKEDITOR.dtd[a] || (b = b.clone(), b.parent = d, 
                d = b, g.splice(f, 1), f--);
            }
        }
        function c(a, f) {
        ...
        f.onTagOpen = function(a, k) {
            ...
            if (CKEDITOR.dtd.$removeEmpty[a]) g.push(e); else {
                ...
                if (p && !p[a]) {
                    var p = !1, l;
                    a == w ? h(d, d.parent) : (a in CKEDITOR.dtd.$listItem ? (f.onTagOpen("ul", {}), 
                    l = d) : (h(d, d.parent), g.unshift(d)), p = !0);
        ...
        f.onTagClose = function(a) {
            ...
            for (var b = [], c = [], e = d; e.type && e.name != a; ) e._.isBlockLike || c.unshift(e), 
            b.push(e), e = e.parent;
            if (e.type) {
            ...
            if (!f || f["#"]) c(), b(), a.replace(/(\r\n|[\r\n])|[^\r\n]*/g, function(a, f) {
                if (void 0 !== f && f.length) e++; else if (a.length) {
                    ...
                    a.replace(r, function(f, c) {
                        ...
                        h(new CKEDITOR.htmlParser.element("smiley", {
                            desc: B[f]
                        }), d);
                        b = c + f.length;
                    });
        ...
        for (f.parse(CKEDITOR.tools.htmlEncode(a)); d.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT; ) a = d.parent, 
        h(d, a), d = a;
        return k;
    };
    var v = new (CKEDITOR.tools.createClass({
        ...
        proto: {
            ...
            attribute: function(a, b) {
                "option" == a && this.write("=", b);
            },
            closeTag: function(a) {
                a in l && (this.getRule(a, "breakBeforeClose") && this.lineBreak(1), "*" != a && this.write("[/", a, "]"), 
        ...
        init: function(a) {
            ...
            h.addRules({
                elements: {
                    ...
                    span: function(a) {
                        var b;
                        if (b = a.attributes.bbcode) "img" == b ? (a.name = "img", a.attributes.src = a.children[0].value, 
                        a.children = []) : "email" == b && (a.name = "a", a.attributes.href = "mailto:" + a.children[0].value), 
                ...
                elements: {
                    $: function(b) {
                        ...
                        if (d in x) d = x[d]; else if ("span" == d) if (e = g.color) d = "color", e = CKEDITOR.tools.convertRgbToHex(e); else {
                            ...
                            if (e = c.href) -1 !== e.indexOf("mailto:") ? (d = "email", b.children = [ new CKEDITOR.htmlParser.text(e.replace("mailto:", "")) ], 
                            e = "") : ((d = 1 == b.children.length && b.children[0]) && d.type == CKEDITOR.NODE_TEXT && d.value == e && (e = ""), 
                            d = "url");
                        } else if ("img" == d) {
                            b.isEmpty = 0;
